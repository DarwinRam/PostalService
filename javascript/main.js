...
function addOneDayPackage(sender, receiver, senderAddr, receiverAddr, weight, costPerUnit, trackingNum, flatFee) {
    manager.addPackage(new OneDayPackage(sender, receiver, senderAddr, receiverAddr, weight, costPerUnit, trackingNum, flatFee));
}
function addTwoDayPackage(sender, receiver, senderAddr, receiverAddr, weight, costPerUnit, trackingNum, flatFee) {
...
function searchPackageByTrackingNumber(trackingNumber) {
    manager.searchPackage(trackingNumber);
}
function updatePackageStatus(trackingNumber, newStatus) {
